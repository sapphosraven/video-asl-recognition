...
parser.add_argument('--dataset-dir', type=str, required=True, help='Path to save downloaded videos')
parser.add_argument('--split-json', type=str, required=True, help='Path to the JSON file with video metadata')
...
if __name__ == '__main__':
    ...
    download_nonyt_videos(args.split_json, saveto=args.dataset_dir)

    check_youtube_dl_version()
    logging.info('Start downloading youtube videos.')
    download_yt_videos(args.split_json, saveto=args.dataset_dir)